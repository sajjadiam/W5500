...
/*                             Configuration                                */
/****************************************************************************/
#define ALCD_RS_GPIO                      GPIOB
#define ALCD_RS_PIN                       GPIO_PIN_0

#define ALCD_RW_GPIO                      GPIOB
#define ALCD_RW_PIN                       GPIO_PIN_1

#define ALCD_EN_GPIO                      GPIOB
#define ALCD_EN_PIN                       GPIO_PIN_3

#define ALCD_D4_GPIO                      GPIOB
#define ALCD_D4_PIN                       GPIO_PIN_4

#define ALCD_D5_GPIO                      GPIOB
#define ALCD_D5_PIN                       GPIO_PIN_5

#define ALCD_D6_GPIO                      GPIOB
#define ALCD_D6_PIN                       GPIO_PIN_6

#define ALCD_D7_GPIO                      GPIOB
#define ALCD_D7_PIN                       GPIO_PIN_7
