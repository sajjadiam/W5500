...
typedef enum{	//Common Register Block
	// Mode
	W5500_CRB_ADDR_MR					= 0x0000,	
	// Gateway Address
	W5500_CRB_ADDR_GAR0				= 0x0001,
	W5500_CRB_ADDR_GAR1				= 0x0002,
	W5500_CRB_ADDR_GAR2				= 0x0003,
	W5500_CRB_ADDR_GAR3				= 0x0004,
	// Subnet Mask Address
	W5500_CRB_ADDR_SUBR0				= 0x0005,
	W5500_CRB_ADDR_SUBR1				= 0x0006,
	W5500_CRB_ADDR_SUBR2				= 0x0007,
	W5500_CRB_ADDR_SUBR3				= 0x0008,
	// Source Hardware Address (MAC ADDRESS)
	W5500_CRB_ADDR_SHAR0				= 0x0009,
	W5500_CRB_ADDR_SHAR1				= 0x000A,
	W5500_CRB_ADDR_SHAR2				= 0x000B,
	W5500_CRB_ADDR_SHAR3				= 0x000C,
	W5500_CRB_ADDR_SHAR4				= 0x000D,
	W5500_CRB_ADDR_SHAR5				= 0x000E,
	// Source IP Address
	W5500_CRB_ADDR_SIPR0				= 0x000F,
	W5500_CRB_ADDR_SIPR1				= 0x0010,
	W5500_CRB_ADDR_SIPR2				= 0x0011,
	W5500_CRB_ADDR_SIPR3				= 0x0012,
	// Interrupt Low Level Timer
	W5500_CRB_ADDR_INTLEVEL0		= 0x0013,
	W5500_CRB_ADDR_INTLEVEL1		= 0x0014,
	// Interrupt
	W5500_CRB_ADDR_IR					= 0x0015,
	// Interrupt Mask
	W5500_CRB_ADDR_IMR					= 0x0016,
	// Socket Interrupt 
	W5500_CRB_ADDR_SIR					= 0x0017,
	// Socket Interrupt Mask
	W5500_CRB_ADDR_SIMR					= 0x0018,
	// Retry Time
	W5500_CRB_ADDR_RTR0					= 0x0019,
	W5500_CRB_ADDR_RTR1					= 0x001A,
	// Retry Count
	W5500_CRB_ADDR_RCR					= 0x001B,
	// PPP LCP Request Timer
	W5500_CRB_ADDR_PTIMER				= 0x001C,
	// PPP LCP Magic number
	W5500_CRB_ADDR_PMAGIC				= 0x001D,
	// PPP Destination MAC Address
	W5500_CRB_ADDR_PHAR0				= 0x001E,
	W5500_CRB_ADDR_PHAR1				= 0x001F,
	W5500_CRB_ADDR_PHAR2				= 0x0020,
	W5500_CRB_ADDR_PHAR3				= 0x0021,
	W5500_CRB_ADDR_PHAR4				= 0x0022,
	W5500_CRB_ADDR_PHAR5				= 0x0023,
	// PPP Session Identification
	W5500_CRB_ADDR_PSID0				= 0x0024,
	W5500_CRB_ADDR_PSID1				= 0x0025,
	// PPP Maximum Segment Size
	W5500_CRB_ADDR_PMRU0				= 0x0026,
	W5500_CRB_ADDR_PMRU1				= 0x0027,
	// Unreachable IP address
	W5500_CRB_ADDR_UIPR0				= 0x0028,
	W5500_CRB_ADDR_UIPR1				= 0x0029,
	W5500_CRB_ADDR_UIPR2				= 0x002A,
	W5500_CRB_ADDR_UIPR3				= 0x002B,
	// Unreachable Port
	W5500_CRB_ADDR_UPORTR0			= 0x002C,
	W5500_CRB_ADDR_UPORTR1			= 0x002D,
	// PHY Configuration
	W5500_CRB_ADDR_PHYCFGR			= 0x002E,
	// Reserved				0x002F~0x0038
	// Chip version
	W5500_CRB_ADDR_VERSIONR		= 0x0039,
	// Reserved				0x003A~0xFFFF
}w5500_cr_addr_t;
typedef enum{	//Socket Register Block
	// Socket n Mode
	W5500_SRB_ADDR_Sn_MR				= 0x0000,
	// Socket n Command
	W5500_SRB_ADDR_Sn_CR				= 0x0001,
	// Socket n Interrupt
	W5500_SRB_ADDR_Sn_IR				= 0x0002,
	// Socket n Status
	W5500_SRB_ADDR_Sn_SR				= 0x0003,
	// Socket n Source Port
	W5500_SRB_ADDR_Sn_PORT0				= 0x0004,
	W5500_SRB_ADDR_Sn_PORT1				= 0x0005,
	// Socket n Destination Hardware Address
	W5500_SRB_ADDR_Sn_DHAR0				= 0x0006,
	W5500_SRB_ADDR_Sn_DHAR1				= 0x0007,
	W5500_SRB_ADDR_Sn_DHAR2				= 0x0008,
	W5500_SRB_ADDR_Sn_DHAR3				= 0x0009,
	W5500_SRB_ADDR_Sn_DHAR4				= 0x000A,
	W5500_SRB_ADDR_Sn_DHAR5				= 0x000B,
	// Socket n Destination IP Address
	W5500_SRB_ADDR_Sn_DIPR0				= 0x000C,
	W5500_SRB_ADDR_Sn_DIPR1				= 0x000D,
	W5500_SRB_ADDR_Sn_DIPR2				= 0x000E,
	W5500_SRB_ADDR_Sn_DIPR3				= 0x000F,
	// Socket n Destination Port
	W5500_SRB_ADDR_Sn_DPORT0			= 0x0010,
	W5500_SRB_ADDR_Sn_DPORT1			= 0x0011,
	// Socket n Maximum Segment Size
	W5500_SRB_ADDR_Sn_MSSR0				= 0x0012,
	W5500_SRB_ADDR_Sn_MSSR1				= 0x0013,
	// Reserved						0x0014,
	// Socket n IP TOS 
	W5500_SRB_ADDR_Sn_TOS				= 0x0015,
	// Socket n IP TTL 
	W5500_SRB_ADDR_Sn_TTL				= 0x0016,
	// Reserved						0x0017~0x001D
	// Socket n Receive Buffer Size
	W5500_SRB_ADDR_Sn_RXBUF_SIZE		= 0x001E,
	//Socket n Transmit Buffer Size
	W5500_SRB_ADDR_Sn_TXBUF_SIZE		= 0x001F,
	// Socket n TX Free Size
	W5500_SRB_ADDR_Sn_TX_FSR0			= 0x0020,
	W5500_SRB_ADDR_Sn_TX_FSR1			= 0x0021,
	// Socket n TX Read Pointer
	W5500_SRB_ADDR_Sn_TX_RD0			= 0x0022,
	W5500_SRB_ADDR_Sn_TX_RD1			= 0x0023,
	// Socket n TX Write Pointer
	W5500_SRB_ADDR_Sn_TX_WR0			= 0x0024,
	W5500_SRB_ADDR_Sn_TX_WR1			= 0x0025,
	// Socket n RX Received Size
	W5500_SRB_ADDR_Sn_RX_RSR0			= 0x0026,
	W5500_SRB_ADDR_Sn_RX_RSR1			= 0x0027,
	// Socket n RX Read Pointer
	W5500_SRB_ADDR_Sn_RX_RD0			= 0x0028,
	W5500_SRB_ADDR_Sn_RX_RD1			= 0x0029,
	// Socket n RX Write Pointer
	W5500_SRB_ADDR_Sn_RX_WR0			= 0x002A,
	W5500_SRB_ADDR_Sn_RX_WR1			= 0x002B,
	// Socket n Interrupt Mask
	W5500_SRB_ADDR_Sn_IMR				= 0x002C,
	// Socket n Fragment Offset in IP header
	W5500_SRB_ADDR_Sn_FRAG0				= 0x002D,
	W5500_SRB_ADDR_Sn_FRAG1				= 0x002E,
	//Keep alive timer 
	W5500_SRB_ADDR_Sn_KPALVTR			= 0x002F,
